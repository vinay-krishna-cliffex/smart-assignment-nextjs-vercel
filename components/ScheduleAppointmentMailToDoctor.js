...
export const ScheduleAppointmentMailToDoctor = (location, date, time, name, docId, patientId) => {
  return ` <div
    class="email_summary"
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            >
                              You have a new Appointment from <br />${name}
                            </h2>
                            <p
                            ...
                            >
                              ...
                              >
                                <ul>
                                  ...
                                  >
                                    <a
                                      href="${docSiteUrl}/confirm?date=${date}&time=${time}&id=${docId}&patientId=${patientId}&status=0"
                                  ...
                                  >
                                    <a
                                      href="${docSiteUrl}/confirm?date=${date}&time=${time}&id=${docId}&patientId=${patientId}&status=2"
                                      style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;text-decoration: none;color: #ffffff;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 0px;word-break: break-word;font-weight: bold;"
                                      ><span
                                        style="color: #ffffff;text-decoration: none;"
                                        >Cancel</span
                                  ...
                                  >
                                    <a
                                      href="${docSiteUrl}/confirm?date=${date}&time=${time}&id=${docId}&patientId=${patientId}&status=1"
                                      style="-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;text-decoration: none;color: #ffffff;font-family: Arial, Helvetica, sans-serif;margin-top: 0px;margin-bottom: 0px;word-break: break-word;font-weight: bold;"
                                      ><span
                                        style="color: #ffffff;text-decoration: none;"
                                        >Re-Schedule</span
