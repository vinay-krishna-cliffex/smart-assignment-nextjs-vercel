...
export const ScheduleAppointmentMailToPatient = (location, date, time, name, docId, patientId) => {
  return ` <div
    class="email_summary"
                      ...
                      <tbody>
                        <tr>
                          ...
                          >
                            ...
                            >
                              Your Appointment has been scheduled with <br />Dr. ${name}
                            </h2>
                            <p
                            ...
                            >
                              <tbody>
                                <tr
                                  style="display: flex;justify-content: space-around;width:110%;"
                                >
                                  <td
                                    class="bg_primary"
                                    style="background-color: #47b475;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 5pt;mso-table-rspace: 0pt;font-size: 16px;padding: 13px 40px;border-radius: 4px;line-height: normal;text-align: center;font-weight: bold;-webkit-transition: box-shadow .25s;transition: box-shadow .25s;"
                                  >
                                    <a
                                      href='${patientSiteUrl}/confirm?date=${date}&time=${time}&docId=${docId}&id=${patientId}&status=2'
                            ...
                            >
                              You'll receive an email again once the doctor
                              has CONFIRMED this appointment.
                            </p>
                          </td>
                        </tr>
                      </tbody>
